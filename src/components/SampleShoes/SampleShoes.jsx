...
const HERO_IMAGE = "https://cdn.builder.io/api/v1/image/assets%2Fd7feb1a142b342fbacaee745f4047570%2F7526e605ff9941be9e97090906d8fa04?format=webp&width=800";
    ...
    return (
      <section className={`sample-shoes sample-shoes-${variant}`} aria-hidden>
        <div className="sample-hero-wrap">
          <img src={HERO_IMAGE} alt="hero" className="sample-hero-image" />
        </div>
      </section>
    );
  }
